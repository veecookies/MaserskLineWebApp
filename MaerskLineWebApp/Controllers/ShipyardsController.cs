...
namespace MaerskLineWebApp.Controllers
{
    public class ShipyardsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShipyardID,Shipyard_Name,Shipyard_Location")] Shipyard shipyard)
        {
        ...
        public ActionResult Edit([Bind(Include = "ShipyardID,Shipyard_Name,Shipyard_Location")] Shipyard shipyard)
        {
            if (ModelState.IsValid)
            {
