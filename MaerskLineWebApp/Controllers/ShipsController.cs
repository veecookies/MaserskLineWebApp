...
namespace MaerskLineWebApp.Controllers
{
    public class ShipsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShipID,Ship_Name,Ship_Description,Max_Containers")] Ship ship)
        {
        ...
        public ActionResult Edit([Bind(Include = "ShipID,Ship_Name,Ship_Description,Max_Containers")] Ship ship)
        {
            if (ModelState.IsValid)
            {
