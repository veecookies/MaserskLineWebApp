...
namespace MaerskLineWebApp.Controllers
{
    public class ContainersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ContainerID,Container_Description,Container_Weight")] Container container)
        {
        ...
        public ActionResult Edit([Bind(Include = "ContainerID,Container_Description,Container_Weight")] Container container)
        {
            if (ModelState.IsValid)
            {
